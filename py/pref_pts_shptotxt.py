...
if __name__ == '__main__':
    result = ReadVectorFile(r'D:\HTML_Project\map_data\pref_pts\v6_time_pref_pts_utf_wgs84\v6_time_pref_pts_utf_wgs84.shp')
    
    f_new=open(r'D:\HTML_Project\map_data\v6_time_pref_pts_utf_wgs84.txt','a',encoding='utf-8')
